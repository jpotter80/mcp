...
Usage patterns:
- Replace placeholders like {{MCP_NAME}} with actual values during scaffolding
...
TABLE_NAME = os.getenv("{{MCP_NAME_UPPER}}_TABLE_NAME", "{{TOOL_NAME}}_{{DOC_TYPE}}_indexed")
...
def main():
    parser = argparse.ArgumentParser(description="{{DOC_TYPE}} Documentation Hybrid Search")
