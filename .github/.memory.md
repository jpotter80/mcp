...
**Currently on Phase 2**: `restructure/02-multi-format-doc-support`
- Files created: BaseDocumentProcessor, MarkdownProcessor, ProcessorFactory, utils
- Next: Update preprocessing/src/mdx_processor.py to inherit from BaseDocumentProcessor
- Then: Update pipeline.py to use factory pattern
- Then: Verify & test
- Finally: Commit & merge to main
