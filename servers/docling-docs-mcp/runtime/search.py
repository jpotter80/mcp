...
_DEFAULT_DB_PATH = os.path.join(_RUNTIME_DIR, "docling_docs_mcp.db")

DB_PATH = os.getenv("DOCLING_DOCS_MCP_DB_PATH", _DEFAULT_DB_PATH)
TABLE_NAME = os.getenv("DOCLING_DOCS_MCP_TABLE_NAME", "docling_docs_indexed")
