...
_DEFAULT_DB_PATH = os.path.join(_RUNTIME_DIR, "mcp_docs_mcp.db")

DB_PATH = os.getenv("MCP_DOCS_MCP_DB_PATH", _DEFAULT_DB_PATH)
TABLE_NAME = os.getenv("MCP_DOCS_MCP_TABLE_NAME", "mcp_docs_indexed")
